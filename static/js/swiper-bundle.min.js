...
!function(e, t) {
            ...
            attachEvents: function() {
                ...
                if (!l.touch && l.pointerEvents)
                    ...
                    if (l.touch) {
                        ...
                        G || (e.addEventListener("touchstart", N),
                        G = !0)
                    }
    ...
    var U = {
        ...
        animateSlider: function(e) {
            var t = l();
            return e.delta >= 6 && x() - this.mousewheel.lastScrollTime < 60 || (e.direction < 0 ? this.isEnd && !this.params.loop || this.animating || (this.slideNext(),
